<?php
/**
 * Widget API: WP_Widget_Archives_Custom_Yearly class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class WP_Widget_Archives_Custom_Yearly extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'widget_archive_yearly',
			'description' => __( 'A yearly archive of your site&#8217;s Posts.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct('archives', __('Archives Yearly'), $widget_ops);
	}
	...
	public function widget( $args, $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Archives Yearly' );
	 ...
	 *                            WP_Widget_Archives_Custom_Yearly::form().
