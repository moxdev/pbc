...
function promo_box_club_scripts() {
	...
	wp_enqueue_script( 'promo_box_club-navigation', get_template_directory_uri() . '/js/min/navigation-min.js', array(), '20151215', true );
...
/**
 * Home Page See What's Inside Section.
 */
